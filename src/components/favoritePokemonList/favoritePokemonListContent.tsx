...
interface FavoritePokemonListContentProps {
    currentFavoritePokemonList: Pokemon[];
    favoritePokemons: any;
    handleFavorites: any;
    handleOpenPopUpInfo: any;
}
export function FavoritePokemonListContent({currentFavoritePokemonList, favoritePokemons, handleFavorites, handleOpenPopUpInfo }: FavoritePokemonListContentProps) {
                ...
                <Card key={pokemon.name} type={pokemon.typeNames} onClick={(e) => handleOpenPopUpInfo(pokemon, e)}>
                    <CardTop>
                        <Text>
                            ...
                            {favoritePokemons && favoritePokemons.some((fav:any) => fav.name === pokemon.name) ?
